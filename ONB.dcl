 ...
 *
 * Input: normalized vector 'u' and 'w'
 * Output: ONB basis matrix 
 * 
 * Example: setFromUW (Vec3normalize {x0 = 0.0, x1 =  0.0,  x2 = 1.0}) (Vec3normalize {x0 = 0.0, x1 =  1.0,  x2 = 0.0})
 ...
 * 
 * Input: normalized vector 'v'
 * Output: ONB basis matrix 
 * 
 * Example: setFromV  (Vec3normalize {x0 = ~5.5, x1 =  0.0,  x2 = 0.0})
